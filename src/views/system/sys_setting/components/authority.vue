  ...
  <el-row class="pd_b_20 pd_t_20">
    <el-col :span="24">
      <ElForm ref="formRef" :model="form" label-width="300px" :rules="rules">
        <el-row>
          <el-col :span="16">
            <ElFormItem label="检测查询总共开关" class="flex_start" prop="isQuery">
              <el-switch
        ...
        <el-row>
          <el-col :span="16">
            <ElFormItem label="检测真实金额大于多少的用户(USD)" prop="userAmount">
              <ElInput
        ...
        <el-row>
          <el-col :span="16">
            <ElFormItem label="检测记录">
              <ElButton type="success" @click="checkRecord" round
                >点击查看授权检测记录</ElButton
              >
            </ElFormItem>
          </el-col>
...
const rules = reactive({
  isQuery: [{ required: true, message: "请选择检测查询总开关", trigger: "blur" }],
});
